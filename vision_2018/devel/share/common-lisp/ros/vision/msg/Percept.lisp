...
(cl:defmethod gaze-val ((m <Percept>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vision-msg:gaze-val is deprecated.  Use vision-msg:gaze instead.")
  (gaze m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Percept>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'gaze) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Percept>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'gaze) istream)
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Percept>)))
  ...
  "9344e4234c8f4273738fa03ee0fe972f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Percept)))
  "Returns md5sum for a message object of type 'Percept"
  "9344e4234c8f4273738fa03ee0fe972f")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Percept>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'gaze))
))
