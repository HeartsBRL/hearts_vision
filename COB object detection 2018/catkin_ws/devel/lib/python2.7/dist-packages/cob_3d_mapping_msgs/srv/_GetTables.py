...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3I.pack(_x.tables.header.seq, _x.tables.header.stamp.secs, _x.tables.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.tables.header.seq, _x.tables.header.stamp.secs, _x.tables.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
