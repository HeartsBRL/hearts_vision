...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_i3I.pack(_x.action, _x.shapes.header.seq, _x.shapes.header.stamp.secs, _x.shapes.header.stamp.nsecs))
      ...
      for val1 in self.shapes.shapes:
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        _x = val1
        buff.write(_struct_bif.pack(_x.type, _x.id, _x.weight))
        _v3 = val1.pose
        _v4 = _v3.position
        _x = _v4
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action, _x.shapes.header.seq, _x.shapes.header.stamp.secs, _x.shapes.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      ...
      for i in range(0, length):
        ...
        (_x.type, _x.id, _x.weight,) = _struct_bif.unpack(str[start:end])
        _v11 = val1.pose
        _v12 = _v11.position
        _x = _v12
        start = end
